...
class UniversityChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create university_choice" do
    assert_difference('UniversityChoice.count') do
      post university_choices_url, params: { university_choice: { choice_order: @university_choice.choice_order, program_choice_id: @university_choice.program_choice_id, university_id: @university_choice.university_id } }
    end
  ...
  test "should update university_choice" do
    patch university_choice_url(@university_choice), params: { university_choice: { choice_order: @university_choice.choice_order, program_choice_id: @university_choice.program_choice_id, university_id: @university_choice.university_id } }
