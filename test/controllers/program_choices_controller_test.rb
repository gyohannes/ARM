...
class ProgramChoicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create program_choice" do
    assert_difference('ProgramChoice.count') do
      post program_choices_url, params: { program_choice: { applicant_id: @program_choice.applicant_id, choice_order: @program_choice.choice_order, program_id: @program_choice.program_id } }
    end
  ...
  test "should update program_choice" do
    patch program_choice_url(@program_choice), params: { program_choice: { applicant_id: @program_choice.applicant_id, choice_order: @program_choice.choice_order, program_id: @program_choice.program_id } }
