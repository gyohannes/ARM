class DeclarationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @declaration.save
        format.html { redirect_to declarations_path, notice: 'Declaration was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @declaration.update(declaration_params)
        format.html { redirect_to declarations_path, notice: 'Declaration was successfully updated.' }
  ...
  private
    ...
    def declaration_params
      params.require(:declaration).permit(:name)
    end
end
